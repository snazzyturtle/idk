...
body {
background: url("https://s-media-cache-ak0.pinimg.com/originals/16/7e/79/167e791030e847616ebc4852c3056ede.jpg") fixed;
...
.main {
background: rgba(200, 245, 212, 0.46);
border: 1px solid #000;
box-shadow: none;
}
...
.sidebar {
background: rgba(200, 245, 212, 0.36);
